...
function Cart() {
    ...
    const { cart, handleDeleteitem } = useContext(ecomContext);
    // console.log(cart);
                    ...
                    <div className='container mx-auto grid grid-cols-1 md:grid-cols-5 gap-8'>
                        <div className='w-full md:col-span-4 bg-white px-4'>
                            ...
                            <div className='w-full'>
                                {cart.map((item, index) => (
                                    <div key={index} className='w-full border-b border-gray-300 p-4 flex flex-col md:flex-row items-center gap-6'>
                                        ...
                                        <div className='w-full md:w-1/2'>
                                          ...
                                          <p className=''>Qty:</p>
                                          <p className='cursor-pointer bg-gray-300 px-1 rounded-md hover:bg-gray-400 duration-300'>-</p>
                                          <p>{item.quantity}</p>
                                          <p className='cursor-pointer bg-gray-300 px-1 rounded-md hover:bg-gray-400 duration-300'>+</p>
                                        </div> */}
                                        ...
                                        <div className='ml-auto'>
                                            <h2 className='font-bold text-xl'>${item.product_price}</h2>
                                        </div>
                                    </div>
                                ))}
                            </div>
